...
public class SetController {
    ...
    public Label rightsLabel, primLabel, hintLabel;
    ...
    void initialize() throws SQLException {
        ...
        while (result.next()) {
            nameField.setText(result.getString(Const.USERS_NAME));
            ...
            visCheck.setSelected(!result.getBoolean(Const.USERS_VISIBILITY));
            infoField.setText(result.getString(Const.USERS_ABOUT));
        ...
        visCheck.setFont(font);
        primLabel.setFont(font);
    }
    ...
    public void changeInfo() throws SQLException, ClassNotFoundException {
        ...
        dbHandler.updateUser(id, contField.getText(), passField.getText(), datePicker.getValue(), !visCheck.isSelected(), infoField.getText());
